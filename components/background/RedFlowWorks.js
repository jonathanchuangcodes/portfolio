...
export default function RedFlowWork() {
  return (
    <svg
      ...
      className="red-flow-2"
    >
      <path
        fill="#DA6A71"
        d="M-.166.563s-71.46 244 .166 244c71.626 0 440.221 168.7 619.773 159.063C981.364 384.22 1291 656.063 1377 616.063s261.5-312.5 27-187-306.55-168.748-784.227-168.748C309.047 260.315 18.723 19.591-.166.563z"
      ></path>
      <path
        fill="url(#pattern1)"
        fillOpacity="0.1"
      ...
      <path
        fill="#DA6A71"
        d="M790.93 635.622c-201.61-52.971-442.202 93.813-538.31 160.43C174.077 850.494 44.024 939.088 0 972.563V751.126c164.923-102.139 455.274-336.215 864.451-219.925 304.169 86.445 523.409-98.735 638.369-162.638 0 0 2.97 169.717-.5 172.521-132.08 106.676-373.18 183.397-711.39 94.538z"
      ></path>
      <path
        fill="url(#pattern1)"
        fillOpacity="0.1"
      ...
      <defs>
        ...
        >
          <use
            transform="matrix(0 .0008 -.00032 0 .098 0)"
            xlinkHref="#image0_570_465"
          ></use>
        </pattern>
        <pattern
          id="pattern1"
        ...
        >
          <use
            transform="matrix(0 .00083 -.00033 0 .101 0)"
            xlinkHref="#image0_570_465"
          ></use>
        </pattern>
        <image
