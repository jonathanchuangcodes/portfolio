...
import livescoreHome from "@/public/football-dashboard-alpha/livescore_home.png"
import livescoreFavorites from "@/public/football-dashboard-alpha/livescore_favorites.png"
import soccer24Home from "@/public/football-dashboard-alpha/soccer24_home.png"
import soccer24BottomHome from "@/public/football-dashboard-alpha/soccer24_bottom_home.png"
import espnHome from "@/public/football-dashboard-alpha/espn_home.png"
import foxHome from "@/public/football-dashboard-alpha/fox_home.png"
import whoscoredHome from "@/public/football-dashboard-alpha/whoscored_home.png"
import competitionspageLeague from "@/public/football-dashboard-alpha/competitionspage_league.png"
import competitionspageGroupstage from "@/public/football-dashboard-alpha/competitionspage_groupstage.png"
import footballdashboardSitemap from "@/public/football-dashboard-alpha/footballdashboardsitemap.png"
import homepageV1 from "@/public/football-dashboard-alpha/homepagev1.png"
import homepageV2 from "@/public/football-dashboard-alpha/homepagev2.png"
import teampageV2 from "@/public/football-dashboard-alpha/teampagev2.png"
import competitionpageV2 from "@/public/football-dashboard-alpha/competitionpagev2.png"
import onboardingSignInEmail from "@/public/football-dashboard-alpha/onboarding(SignInEmail).png"
import onboardingSignInEmailEntered from "@/public/football-dashboard-alpha/onboarding(SignInEmailEntered).png"
import onboardingVerificationLinkSent from "@/public/football-dashboard-alpha/onboarding(VerificationLinkSent).png"
import onboardingChooseTeams from "@/public/football-dashboard-alpha/onboarding(ChooseTeams).png"
import onboardingChooseCompetitions from "@/public/football-dashboard-alpha/onboarding(ChooseCompetitions).png"
import getWork from "@/lib/works"

export const metadata = {
  title: "Football Dashboard: Alpha Version",
  thumbnail: "/football-dashboard-alpha/thumbnail.png",
  ...
  color: "#2E3A59",
  featured: false,
  slug: "football-dashboard-alpha",
  icons: [
    "firebase", "react", "redux", "materialui"
  ]
}

export default async function FootballDashboardAlpha({ children }) {
  let data = await getWork(metadata.slug)
return <MdxLayout data={data}>{children}</MdxLayout>
}

# Football Dashboard: Alpha Version
...
<LightboxImages images={[livescoreFavorites]} />

Soccer24 has a Favorites feature too but only for Teams and Leagues.

<LightboxImages images={[soccer24Home]} />
...
<LightboxImages images={[soccer24BottomHome]} />
...
<LightboxImages images={[livescoreHome, soccer24Home]} />
...
<LightboxImages images={[espnHome]} />
...
<LightboxImages images={[foxHome, livescoreHome]} />
...
<LightboxImages images={[soccer24Home, whoscoredHome]} />
...
<LightboxImages images={[homepageV1]} />
...
<LightboxImages images={[competitionspageLeague, competitionspageGroupstage]} />
...
<LightboxImages images={[footballdashboardSitemap]} />
...
<LightboxImages images={[homepageV2]} />
...
<LightboxImages images={[teampageV2, competitionpageV2]} />
...
<LightboxImages
  images={[
    onboardingSignInEmail,
    onboardingSignInEmailEntered,
    onboardingVerificationLinkSent,
  ]}
/>
...
<LightboxImages
  images={[onboardingChooseTeams, onboardingChooseCompetitions]}
/>
