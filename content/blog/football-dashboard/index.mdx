...
link: https://football.gatsbyjs.io/
...
design:
  - value: >-
      <FigmaFill strokeWidth={2} size={32} />
development:
  - value: >-
      <ReactFill strokeWidth={2} size={32} />
      <SassFill strokeWidth={2} size={32} />
      <GatsbyFill strokeWidth={2} size={32} />
      <JavascriptFill strokeWidth={2} size={32} />
---

[Dashboard.football](https://football.gatsbyjs.io/) is a dashboard web application that will allows users to keep track of
multiple soccer competitions that they follow in one place.

You can view the original source code for this project on my github [here](https://github.com/jchuang02/football).
...
The individual match page is currently being developed into a modal that shows more detailed information like a match timeline,
team statistics, and player statistics.

<LightboxImage
  images={[
    {
      title: "matchpage(VerticalTimeline).png",
