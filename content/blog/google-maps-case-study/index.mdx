...
<div className="row">
  ...
  ![Step 1: Search for Destination](assets/Untitled.png)
  Step 1: Search for Destination

  </div>
  <div className="col">

  ![Step 2: Confirm and Start Navigation](assets/Untitled-1.png)
  Step 2: Confirm and Start Navigation

  </div>
  <div className="col">

  ![Step 3: Follow and Drive](assets/Untitled-1.png)
...
![High fidelity mockups](assets/thumbnail.png)
...
![Google Maps Mockup Case 1](assets/Google-Maps-Mockup-Case-1.png)
...
![Google Maps Mockup Case 2](assets/Google-Maps-Mockup-Case-2.png)
...
![Google Maps Mockup Case 3](assets/Google-Maps-Mockup-Case-3.png)
